...
{
    public partial class kasa_giris_mizer : Form
    {
        public kasa_giris_mizer()
        {
            InitializeComponent();
        }
        ...
        private void kasa_giris_mizer_Load(object sender, EventArgs e)
        {
       ...
       (e.KeyChar != ','))
        ...
        private void stok_ekle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                guncel3.Parameters.AddWithValue("@1_a", 0);
                ...
                guncel3.Parameters.AddWithValue("@5_a", "KASA GİRİŞİ");
                ...
                log_gonder(kadi_getir, ekleyen_adi, "Cari İşlemler", "Kasaya Giriş", "Kasaya Para Girişi Evrak No: " + evrak_no.Text);
