...
{
    public partial class stok_dus_SirtueX : Form
    {
        public stok_dus_SirtueX()
        {
            InitializeComponent();
        }
        int stok = 0;
       ...
       public MySqlConnection mysqlbaglan { get; set; }
        ...
        private void stok_dus_SirtueX_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void stok_ekle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                guncel.ExecuteNonQuery();
                mysqlbaglan.Close();
                log_gonder(adminadi, ekleyen_adi, "Cari İşlemler", "Stok Düşüldü", "Stok Düşülen Ürün Kodu: " + urun_kodu2.Text+" Düşülen Adet sayısı: "+stok_ekle_sayi.Value.ToString());
                MessageBox.Show("Stok başarıyla Düşüldü.");
