...
{
    public partial class borclandir_Mizer : Form
    {
        public borclandir_Mizer()
        {
            InitializeComponent();
        }
        ...
        private void borclandir_Mizer_Load(object sender, EventArgs e)
        {
       ...
       (e.KeyChar != ','))
        ...
        private void stok_ekle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                guncel3.Parameters.AddWithValue("@5_a", "Cari Borçlandırıldı.");
                guncel3.Parameters.AddWithValue("@6_a", odeme_tipi.Text);
                guncel3.Parameters.AddWithValue("@6_b", aciklama.Text);
                guncel3.Parameters.AddWithValue("@6_c", fiyat.Text);
                guncel3.Parameters.AddWithValue("@6_d", "0,00");
                ...
                if (mysqlbaglan.State == ConnectionState.Open) { mysqlbaglan.Close(); }
                log_gonder(kadi_getir, ekleyen_adi, "Cari İşlemler", "Cari Hesap", "Cari Borçlandırıldı Evrak No: " + evrak_no.Text);
        ...
        private void tarih_yenile_Click_1(object sender, EventArgs e)
        {
            fatura_tarihi_gir.Value = DateTime.Now;
        }
    }
