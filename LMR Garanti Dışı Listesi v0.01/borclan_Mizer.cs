...
{
    public partial class borclan_Mizer : Form
    {
        public borclan_Mizer()
        {
            InitializeComponent();
        }

        private void borclan_Mizer_Load(object sender, EventArgs e)
        {
        ...
        private void stok_ekle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                guncel3.Parameters.AddWithValue("@5_a", "Cariye Borçlanıldı.");
                ...
                if (mysqlbaglan.State == ConnectionState.Open) { mysqlbaglan.Close(); }
                log_gonder(kadi_getir, ekleyen_adi, "Cari İşlemler", "Cari Hesap", "Cariye Borçlanıldı Evrak No: " + evrak_no.Text);
