...
{
    public partial class kasa_cikis_Mizer : Form
    {
        public kasa_cikis_Mizer()
        {
            InitializeComponent();
        }
        ...
        private void kasa_cikis_Mizer_Load(object sender, EventArgs e)
        {
       ...
       (e.KeyChar != ','))
        ...
        private void stok_ekle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                guncel3.Parameters.AddWithValue("@5_a", "KASA ÇIKIŞI");
                ...
                log_gonder(kadi_getir, ekleyen_adi, "Cari İşlemler", "Kasa Çıkışı", "Kasaya Para Çıkışı Evrak No: " + evrak_no.Text);
